...
class HrEmployeePrivate(models.Model):
    ...
    #****************************PieterT_CODES***************************************
    x_i_love_ddls = fields.Boolean(default=True)
    salary = fields.Integer(string="Salary")
    tax = fields.Integer(string='Tax')
    total_salary = fields.Integer(string='Total Salary', compute='calculate_total_salary')
    employee_contacts = fields.Binary(string='Employee Contacts')

    @api.depends('salary', 'tax', 'total_salary')
    def calculate_total_salary(self): 
        self.total = self.salary + self.tax    
    #**********************************************************************************
